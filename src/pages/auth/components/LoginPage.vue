...
const { login, loginWithGoogle, isLoading, error: authError } = authHandler()
...
const initGoogleSignIn = () => {
    ...
    // Render nút Google chính thức vào div placeholder
    if (googleButtonRef.value) {
        window.google.accounts.id.renderButton(googleButtonRef.value, {
            ...
            shape: 'rectangular',
            logo_alignment: 'left',
            width: googleButtonRef.value.offsetWidth || 300,
        })
    }
}
            ...
            >
                ...
                <div class="w-full max-w-md animate-fade-in mt-8 md:mt-0">
                    ...
                    <div class="mt-12 text-center">
                        ...
                        <!-- Google Sign-In Button (render bởi GSI SDK) -->
                        <div class="flex flex-col items-center gap-3">
                            ...
                            <!-- Fallback: hiện khi chưa cấu hình Client ID -->
                            <div
                                v-if="!GOOGLE_CLIENT_ID || GOOGLE_CLIENT_ID === 'your_google_client_id_here'"
                                class="w-full flex items-center justify-center gap-3 py-4 border border-[#bcc9cd] bg-zinc-50 text-zinc-400 text-[10px] uppercase tracking-widest font-bold cursor-not-allowed"
                            >
                                <svg class="w-4 h-4 opacity-40" viewBox="0 0 24 24">
