...
const loadGoogleScript = () => {
    if (document.getElementById('google-gsi-script')) { initGoogleSignIn(); return }
...
onUnmounted(() => window.google?.accounts.id.disableAutoSelect())
</script>
                ...
                <div class="w-full max-w-md">
                    ...
                    <div>
                        ...
                        <div
                            ...
                            class="w-full flex items-center justify-center gap-3 py-3 border border-border-light rounded-lg text-text-muted text-[11px] font-medium cursor-not-allowed bg-fashion-gray"
                        >
                            ...
                            Tiếp tục với Google (Chưa cấu hình)
                        </div>
                    </div>
