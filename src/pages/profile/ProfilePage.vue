        ...
        <div class="max-w-[1400px] mx-auto px-6 md:px-12 py-10 flex flex-col md:flex-row gap-8">
            ...
            <section class="flex-1 min-w-0">
                ...
                <ProfileInfoTab
                    ...
                    :height-cm="profileForm.height_cm"
                    :weight-kg="profileForm.weight_kg"
                    ...
                    @update:height-cm="profileForm.height_cm = $event"
                    @update:weight-kg="profileForm.weight_kg = $event"
